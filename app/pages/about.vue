...
<template>
  <div class="min-h-screen bg-white">
    ...
    <main class="py-20">
      ...
      <section class="flex flex-col items-center justify-center px-8 text-center mb-20">
        <h1 class="font-serif text-4xl md:text-5xl font-extrabold text-[#3D3A42] tracking-tighter mb-4">
          ABOUT MOON
        </h1>
        <p class="font-sans text-lg text-neutral-600 max-w-lg">
      ...
      <div class="flex flex-col">
        <EcommerceCard
          ...
          image="/img/backgrounds/bg-32.jpg"
          alt="1910 - Early days"
        />
        <EcommerceCard
          title="1990"
          ...
          image="/img/backgrounds/bg-31.jpg"
          alt="1990 - Expansion"
          reverse
        />
        <EcommerceCard
          ...
          image="/img/backgrounds/bg-30.jpg"
          alt="2010 - Modern era"
        />
      </div>
    </main>
